...
class War {
  ...
  attack(army){
    ...
    let attacker = army === "viking" ? randomViking : randomSaxon;
    let defendant = attacker === randomViking ? randomSaxon : randomViking;
    let result = defendant.receiveDamage(attacker.attack());
